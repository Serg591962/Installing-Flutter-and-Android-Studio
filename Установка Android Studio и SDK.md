...
###### **8.7. Если снапшот текущего состояния (как "спящий режим") повреждён или система подвисла**
